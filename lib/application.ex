defmodule AtmPseudoAppCa.Application do
  alias AtmPseudoAppCa.Infrastructure.EntryPoint.ApiRest
  alias AtmPseudoAppCa.Config.{AppConfig, ConfigHolder}
  alias AtmPseudoAppCa.Utils.CertificatesAdmin
  alias AtmPseudoAppCa.Utils.CustomTelemetry
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: AtmPseudoAppCa.Supervisor]
  ...
  def env_children(_other_env) do
    [
			{AtmPseudoAppCa.Infrastructure.Adapters.Repository.Repo, []},]
  end
end
